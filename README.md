...
# Getting started
This API is developed in spring boot and the reason is because spring boot has an emebedded Tomcat server, it also allows for dependency injections, it has a provision to run jars independently, presence of spring security.
# Prerequisites
  •	Docker
